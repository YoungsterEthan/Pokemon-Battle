...
charizard = Pokemon("CHARIZARD", [fly, fireBlast, flameThrower, scratch], "fire",
                    {'ATTACK': 84, 'DEFENSE': 78, 'HP': 78, 'SPEED': 13}, 36)
blastoise = Pokemon("BLASTOISE", [hydroPump, surf, bite, flashCannon], "water",
                    {'ATTACK': 83, 'DEFENSE': 100, 'HP': 79, 'SPEED': 20}, 36)
